  ...
  return (
    <div className="flex-1 relative group">
      <div className="flex items-center mb-6">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white font-black z-20 shadow-[0_0_20px_rgba(37,99,235,0.3)] group-hover:shadow-blue-500/50 transition-all duration-500 border border-white/10 italic">
          {number}
        </div>
        {!isLast && (
    ...
    <div className="bg-[#050505] text-[#ededed] min-h-screen font-sans selection:bg-blue-500/30 selection:text-white overflow-x-hidden italic">
      ...
      <nav className="fixed w-full z-50 bg-black/60 backdrop-blur-xl border-b border-white/5 italic">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <a href={calendlyUrl} className="bg-white text-black hover:bg-blue-600 hover:text-white px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-wider transition-all shadow-xl active:scale-95 not-italic">
            Book KPI Review
          </a>
        </div>
      </nav>
      ...
      <main className="relative z-10">
        ...
        <section className="py-12 px-6 border-y border-white/5 bg-white/[0.01]">
          <div className="max-w-7xl mx-auto flex flex-wrap justify-center items-center gap-12 opacity-30 grayscale hover:grayscale-0 transition-all duration-700 text-center italic">
            <span className="text-[10px] font-black tracking-[0.3em] w-full text-center mb-4 text-gray-600 uppercase not-italic">Native Integrations</span>
        ...
        {/* 4. PROCESS STEPS - ОНОВЛЕНО */}
        <section id="process" className="py-32 px-6 max-w-7xl mx-auto italic">
          <div className="grid md:grid-cols-3 gap-16 md:gap-8">
            <ProcessStep 
              number="01"
              title="Data Modeling"
              description="API sync and deposit. Starter: 100% upfront. Growth: 50% initial deposit to begin custom modeling."
            />
            <ProcessStep 
              number="02"
              title="Profit Logic"
              description="Custom contribution margin logic built for every SKU. Delivery within 7–14 business days."
            />
            <ProcessStep 
              number="03"
              isLast={true}
              title="Scale Readiness"
              description="Live asset transfer. Final 50% payment due for Growth suite upon successful delivery."
            />
          </div>
        </section>
        ...
        <section id="dashboards" className="py-32 px-6 bg-[#0a0a0a]">
          <div className="max-w-6xl mx-auto text-center italic">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-blue-900/10 group">
              ...
              />
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm not-italic">
        ...
        {/* 6. METRICS GRID */}
        <section id="metrics" className="py-24 px-6 max-w-7xl mx-auto italic">
          <div className="text-center mb-16 italic">
            ...
            <p className="text-gray-500 font-medium not-italic italic">Mission-critical metrics in every dashboard asset.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-10 rounded-[2rem] bg-white/[0.02] border border-white/5 text-center group hover:border-blue-500/50 transition duration-500">
                ...
                <div className="text-[10px] text-gray-500 uppercase tracking-[0.2em] font-bold not-italic">{m.desc}</div>
              </div>
            ))}
          </div>
        </section>

        {/* 7. PRICING SECTION - ОНОВЛЕНО */}
        <section id="pricing" className="py-32 px-6 bg-white/[0.01] border-t border-white/5 italic">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch not-italic">
              ...
              {/* STARTER CARD */}
              <div className="p-12 rounded-[2.5rem] bg-black border border-white/5 flex flex-col hover:border-white/10 transition duration-500 italic">
                <div className="mb-10">
                  <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 not-italic">Starter Asset</span>
                  <div className="text-5xl font-black mt-4 text-white italic">€699</div>
                  <p className="text-blue-500 font-bold text-[10px] mt-2 uppercase not-italic">Full payment required</p>
                </div>
                ...
                <a href={calendlyUrl} className="w-full py-5 rounded-2xl border border-white/20 text-white font-black text-[10px] uppercase tracking-widest text-center hover:bg-white hover:text-black transition-all italic">Get Setup</a>
              </div>

              {/* GROWTH CARD */}
              <div className="p-12 rounded-[2.5rem] bg-blue-600 shadow-[0_0_80px_rgba(37,99,235,0.25)] flex flex-col relative overflow-hidden group italic">
                <div className="absolute top-0 right-0 bg-white text-blue-600 px-8 py-2 text-[10px] font-black uppercase tracking-widest rounded-bl-3xl shadow-2xl not-italic">50/50 Split Available</div>
                <div className="mb-10 relative z-10 text-left">
                  <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/70 not-italic">Full Analytics Suite</span>
                  <div className="text-5xl font-black mt-4 text-white italic">€2,400</div>
                  <p className="text-white/80 font-bold text-[10px] mt-2 uppercase not-italic">€1,200 Deposit / €1,200 Final</p>
                </div>
                ...
                <a href={calendlyUrl} className="w-full py-5 rounded-2xl bg-black text-white font-black text-[10px] uppercase tracking-widest text-center hover:scale-[1.02] transition-all shadow-2xl relative z-10 italic">Scale Brand Now</a>
              </div>
        ...
        {/* 8. FAQ SECTION - ОНОВЛЕНО */}
        <section className="py-32 px-6 max-w-4xl mx-auto italic">
        ...
        <section className="py-32 px-6 italic">
          <div className="max-w-5xl mx-auto p-20 rounded-[4rem] bg-gradient-to-br from-blue-600 to-blue-900 text-center relative overflow-hidden shadow-[0_40px_100px_rgba(37,99,235,0.3)] group italic">
            <h2 className="text-5xl md:text-7xl font-black text-white mb-8 relative z-10 leading-[0.9] italic">Ready to scale?</h2>
            <p className="text-white/70 mb-12 text-lg max-w-xl mx-auto relative z-10 font-medium not-italic italic">Let&apos;s build your single source of truth and fix your profit leakage.</p>
            <a href={calendlyUrl} className="relative z-10 inline-block bg-white text-blue-600 px-16 py-6 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:scale-110 transition shadow-2xl not-italic italic">
      ...
      {/* 10. FOOTER */}
      <footer className="py-24 bg-black border-t border-white/5 px-6 relative z-10 text-center md:text-left italic">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 border-b border-white/5 pb-16 mb-12">
            <div className="text-left italic">
              <div className="text-2xl font-black uppercase tracking-tighter mb-4 text-white">CALYXRA</div>
              <p className="text-gray-600 text-[10px] uppercase tracking-[0.3em] font-bold not-italic">Premium BI Solutions for Shopify</p>
            </div>
            <div className="flex flex-col items-center md:items-end gap-4 not-italic">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-10">
            ...
            <div className="flex gap-10 text-[9px] text-gray-500 uppercase tracking-[0.3em] font-bold not-italic">
