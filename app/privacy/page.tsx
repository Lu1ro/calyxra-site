        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-10 text-stone-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-1"><strong>Contact:</strong> <a href="mailto:admin@calyxra.com" className="text-emerald-700 hover:underline">admin@calyxra.com</a></p>
            ...
            <section>
              ...
              <p className="mt-3 text-sm">To exercise these rights: <a href="mailto:admin@calyxra.com" className="text-emerald-700 hover:underline">admin@calyxra.com</a></p>
            </section>
